...
2. Программа обрабатывает его, и если все параметры корректные, то возвращает JSON с ходом движка,
   новой историей ходов и [FEN](https://ru.wikipedia.org/wiki/%D0%9D%D0%BE%D1%82%D0%B0%D1%86%D0%B8%D1%8F_%D0%A4%D0%BE%D1%80%D1%81%D0%B0%D0%B9%D1%82%D0%B0_%E2%80%94_%D0%AD%D0%B4%D0%B2%D0%B0%D1%80%D0%B4%D1%81%D0%B0)
   текущей позиции.
...
| .`coords`      | **string**, "t", "true", "1", "f", "false", "0"<br>Тру или Фэлс | Рисовать ли рамку с координатами, по умолчанию "t".                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| .`with_engine` | **string**, "t", "true", "1", "f", "false", "0"<br>Тру или Фэлс | Использовать ли движок для анализа позиции в сантипешках, по умолчанию "t". |
